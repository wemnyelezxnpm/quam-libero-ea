...
[![Coverage Status](https://coveralls.io/repos/github/wemnyelezxnpm/quam-libero-ea/badge.svg)](https://coveralls.io/github/wemnyelezxnpm/quam-libero-ea)
[![ci](https://github.com/wemnyelezxnpm/quam-libero-ea/actions/workflows/ci.yml/badge.svg)](https://github.com/wemnyelezxnpm/quam-libero-ea/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@wemnyelezxnpm/quam-libero-ea.svg)](https://www.npmjs.com/package/@wemnyelezxnpm/quam-libero-ea)
[![NPM Downloads](https://img.shields.io/npm/dm/@wemnyelezxnpm/quam-libero-ea.svg)](http://npm-stat.com/charts.html?package=@wemnyelezxnpm/quam-libero-ea)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@wemnyelezxnpm/quam-libero-ea)](https://www.jsdelivr.com/package/npm/@wemnyelezxnpm/quam-libero-ea)
...
```
npm install @wemnyelezxnpm/quam-libero-ea
```
...
import { supportTransform } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { support3DTransform } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@wemnyelezxnpm/quam-libero-ea";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/wemnyelezxnpm/quam-libero-ea/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@wemnyelezxnpm/quam-libero-ea";
...
```js
// Example
import on from "@wemnyelezxnpm/quam-libero-ea/src/event/on";
import addClass from "@wemnyelezxnpm/quam-libero-ea/src/class/addClass";
import getElementById from "@wemnyelezxnpm/quam-libero-ea/src/selectors/getElementById";
import mouseclickEvent from "@wemnyelezxnpm/quam-libero-ea/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/wemnyelezxnpm/quam-libero-ea/blob/master/LICENSE)
